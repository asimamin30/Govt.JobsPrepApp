...
public class ViewPastPaper extends AppCompatActivity {
...
//    public static String _PostCategory = "PPSC";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_past_paper);
    ...
    private void Functionality() {
        ...
        adapter = new PaperAdapter(ViewPastPaper.this,_PostsArrayList);
